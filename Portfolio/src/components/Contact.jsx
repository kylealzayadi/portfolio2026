...
const Contact = () => {
  ...
  return (
    <div
      className={`xl:mt-12 flex xl:flex-row flex-col gap-20 overflow-hidden`}
    >
      <motion.div
      ...
      <motion.div
        ...
        className='flex-[1] xl:flex-1 xl:h-auto md:h-[550px] h-[350px] photo p-7'
      >
        <img src={gradphoto} alt="photo of Nick" />
      </motion.div>
    </div>
  );
};
